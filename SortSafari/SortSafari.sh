...
#if [ "$#" -ge 1 ]; then
#	#第一引数が-i,-o,-cだったら駄目
#	if  [ "$1" = "-i" -o "$1" = "-o" -o "$1" = "-c" ]; then
#		echo "0 : Usage: $CMDNAME InputFileName [-i] [-o OutputFileName] [-c CopyFileName]" 1>&2
#        exit 1 
#    fi
#else
#	echo "1 : Usage: $CMDNAME InputFileName [-i] [-o OutputFileName] [-c CopyFileName]" 1>&2
#    exit 1 
#fi

#VALUE_1="$1"
#echo "InputFileName : $VALUE_1"
